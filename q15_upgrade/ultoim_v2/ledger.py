...
class UltoimV2Ledger:
    ...
    def _migrate(self) -> None:
        ...
        additions = (
            ...
            ("kalshi_depth_missing_reason", "TEXT"),
            ("kalshi_depth_retry_used", "INTEGER DEFAULT 0"),
            # Record-only actual-coin depth/trade context. These sit beside the
            # Kalshi quote-depth columns so research can compare whether the
            # underlying coin book helped or hurt a prediction. Never gated.
            ("spot_depth_status", "TEXT"),
            ("spot_depth_missing_reason", "TEXT"),
            ("spot_depth_source", "TEXT"),
            ("spot_depth_age_seconds", "REAL"),
    ...
    _COLS = (
        ...
        "kalshi_depth_status", "kalshi_depth_missing_reason", "kalshi_depth_retry_used",
        "spot_depth_status", "spot_depth_missing_reason",
        "spot_depth_source", "spot_depth_age_seconds", "spot_depth_trade_age_seconds",
        "spot_depth_best_bid", "spot_depth_best_ask", "spot_depth_mid",
        "spot_depth_spread_bps", "spot_depth_bid_depth_top", "spot_depth_ask_depth_top",
        "spot_depth_bid_depth_levels", "spot_depth_ask_depth_levels",
        "spot_depth_bid_notional_levels", "spot_depth_ask_notional_levels",
        "spot_depth_imbalance", "spot_depth_trade_buy_qty_15s",
        "spot_depth_trade_sell_qty_15s", "spot_depth_trade_net_qty_15s",
        "spot_depth_trade_buy_notional_15s", "spot_depth_trade_sell_notional_15s",
