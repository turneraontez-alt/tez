...
class UltoimV2Runner:
    ...
    def _extract_candidate(self, asset: Any, analysis: Mapping[str, Any], canonical: Any,
        ...
        out = {
            ...
            "yes_bid_depth_contracts": quote.get("yes_bid_depth_contracts"),
            "yes_ask_depth_contracts": quote.get("yes_ask_depth_contracts"),
            "no_bid_depth_contracts": quote.get("no_bid_depth_contracts"),
            "no_ask_depth_contracts": quote.get("no_ask_depth_contracts"),
