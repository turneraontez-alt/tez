...
class HighVolFlipLedger:
    _COLS = (
        ...
        "no_ask_depth_contracts", "spot_depth_source",
        ...
        "spot_depth_trade_buy_qty_15s", "spot_depth_trade_sell_qty_15s",
        "spot_depth_trade_net_qty_15s", "spot_depth_trade_buy_notional_15s",
        "spot_depth_trade_sell_notional_15s", "spot_depth_trade_net_qty_60s",
