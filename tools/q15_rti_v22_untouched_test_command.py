"""Manual authoritative-Kalshi command for V22's one-shot untouched test."""
...
from tools import q15_rti_v22_pretest_command as pretest_command
from tools import q15_rti_v22_untouched_test_runner as runner
