"""Run V15's fourth fully disjoint NON-BTC untouched test once."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--pretest-reservation", default=str(fourth.DEFAULT_PRETEST_STATE),
    )
    parser.add_argument(
        "--test-reservation", default=str(fourth.DEFAULT_TEST_STATE),
    )
