...
from q15_upgrade.checkpoint_v91 import CheckpointPolicyV91  # Q15_V91_APP_INTEGRATION  # Q15_V6_CALIBRATED_EDGE
...
checkpoint_v91 = CheckpointPolicyV91(store)
...
def refresh_loop():
    ...
    while True:
        ...
        try:
            ...
            snaps = checkpoint_v91.run_cycle(snaps, now, ws_health, focus_manager, calibrated_edge, notifier)
...
def q15_v91_diagnostics_ep():
    return jsonify(checkpoint_v91.diagnostics())

@app.route("/api/q15-v9-1/rolling")
def q15_v91_rolling_ep():
    return jsonify(checkpoint_v91.rolling_status())

@app.route("/api/q15-v9-1/predictions")
def q15_v91_predictions_ep():
    return jsonify(checkpoint_v91.predictions_status())
...
def health():
    ...
    return jsonify({
        "status": "ok",
        "q15_v9_1": checkpoint_v91.health(),
